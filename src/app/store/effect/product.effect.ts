...
import { AddProduct, AddProductSuccess, DeleteProduct, DeleteProductSuccess, EProductActions, GetProduct, GetProducts, GetProductsSuccess, GetProductSuccess, UpdateProduct, UpdateProductSuccess } from "../action/product.action";
...
export class ProductEffects {
    ...
    updateProduct$ = createEffect(() => {
        return this._actions$.pipe(
            ...
            map(action => action.payload),
            switchMap(product => this._service.updateProduct(product).pipe(map(() => product))),
